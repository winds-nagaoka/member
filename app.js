...
app.use('/manager/selection/add', express.static(client))
app.use('/manager/selection/edit/:id', express.static(client))
app.use('/manager/selection/detail/:id', express.static(client))
...
app.use('/setting/valid/:key', express.static(client))
app.use('/setting/password', express.static(client))
app.use('/setting/session', express.static(client))
app.use('/setting/admin', express.static(client))
