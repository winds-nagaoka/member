      ...
      <div className={clsx(styles.terms, styles[pc])}>
        ...
        <Text>
          ...
          <div className={styles.provision}>
            ...
            <div className={styles['list-number-second']}>
              <h2>二</h2>
            </div>
            <div>
          ...
          <div className={styles.provision}>
            ...
            <div className={styles['list-number-third']}>
              <h2>三</h2>
            </div>
            <div>
              <p>事務局長は事務局を運営し、通常活動における事務を担当する。</p>
            </div>
            <div className={styles['list-number-fourth']}>
              <h2>四</h2>
            </div>
            <div>
              <p>ステージマネージャーは演奏会活動における事務を担当する。また、演奏会に関する会議を招集する。</p>
            </div>
            <div className={styles['list-number-fifth']}>
              <h2>五</h2>
            </div>
            <div>
              <p>会計は運営資金の出納、出納簿の管理を行う。</p>
            </div>
            <div className={styles['list-number-sixth']}>
              <h2>六</h2>
            </div>
            <div>
              <p>
          ...
          <div className={styles.provision}>
            ...
            <div>
              <p>会員は出演日に欠席しようとするときはあらかじめ代表もしくはパートマネージャーに届け出るものとする。</p>
            </div>
          </div>
          <div className={styles.provision}>
            <div className={styles['sub-title']}>
          ...
          <div className={styles['supplementary-provision']}>
            <h2>付則</h2>
            <ol>
