    ...
    return (
      <div className={'box setting-text' + lib.pcClass(this.props.pc)}>
        <div>
          ...
          <input
            type="password"
            value={this.props.scoreAdminRequestPass}
            onChange={(e) => this.props.setScoreAdminRequestPass(e.target.value)}
            placeholder="パスワード"
          />
        </div>
      </div>
      ...
      <React.Fragment>
        <div className={'contents-header' + lib.pcClass(this.props.pc)}>
          <div className="bread-navigation">
            ...
            <i className="fas fa-chevron-right"></i>
            <Link to="/setting/score/admin">楽譜管理者</Link>
          </div>
          <h2>楽譜管理者</h2>
        ...
        {/* <div className={'box' + lib.pcClass(this.props.pc)}>
          <div className='back-link'>
            <ul>
              <li><Link to='/setting/score'><div className='inner'><Back /><span>戻る</span></div></Link></li>
            </ul>
          </div>
        </div> */}
      </React.Fragment>
