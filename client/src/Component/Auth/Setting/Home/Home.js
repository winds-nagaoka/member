...
class Home extends Component {
  ...
  renderPlayerClose() {
    ...
    return (
      <div className={'box setting-button' + lib.pcClass(this.props.pc)}>
        <div onClick={(e) => this.props.closePlayer(e)} className="button">
          プレイヤーを閉じる
        </div>
      </div>
    )
  ...
  renderRequestEmailValid() {
    if (this.props.user.email && !this.props.user.emailValid) {
      return (
        <div className={'box setting-button' + lib.pcClass(this.props.pc)}>
          <div onClick={() => this.props.requestEmail()} className="button">
            確認メールの再送
          </div>
        </div>
      )
    ...
    const emailValid = this.props.user.email ? (
      this.props.user.emailValid ? (
        ...
        <div className="label ng">
          <span>
            <i className="fas fa-times-circle"></i>未確認
          </span>
        </div>
      )
    ) : (
      ...
      <div>
        <div className="text">
          <div>
            ...
            <span className="light">{this.props.user.userid}</span>
          </div>
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className={'box setting-status' + lib.pcClass(this.props.pc)}>{showUserStatus}</div>
        ...
        <div className={'box setting-list' + lib.pcClass(this.props.pc)}>
          <div className="link">
            <ul>
              ...
              <li className="border-top">
                <div className="link-button" onClick={() => this.props.openFirstTutorial()}>
                  <div className="inner">
                    <span>チュートリアルを開く</span>
                  </div>
                </div>
              </li>
              <li className="border-top">
