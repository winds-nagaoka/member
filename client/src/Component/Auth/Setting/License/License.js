      ...
      <React.Fragment>
        <div className={'contents-header' + lib.pcClass(this.props.pc)}>
          <div className="bread-navigation">
            ...
            <i className="fas fa-chevron-right"></i>
            <Link to="/setting/license">ライセンス情報</Link>
          </div>
          <h2>ライセンス情報</h2>
        </div>
        ...
        <div className={'box license ' + lib.pcClass(this.props.pc)}>
          ...
          <div className="license-detail">
            ...
            <p>
              <i className="fab fa-react"></i>Developed with React
            </p>
            <p>
            ...
            <p>
              <span className="nodejs">SuperAgent</span>
              <span>version</span>
              <span>3.8.2</span>
            </p>
            <h2>Server Dependencies</h2>
            <p>
              <i className="fab fa-node-js"></i>Developed with Node.js
            </p>
            <p>
            ...
            <p>
              <span className="nodejs">NeDB</span>
              <span>version</span>
              <span>1.8.0</span>
            </p>
            ...
            <p>
              <i className="fab fa-js"></i>JavaScript (ECMAScript2018)
            </p>
          </div>
        </div>
