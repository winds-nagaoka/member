...
import { setDisplayBoxModal, changeInputBoxLocate, updateBoxLocate } from '../../../../Actions/ScoreBox'
    ...
    return (
      <React.Fragment>
        <div className="modal-header">
          <div>詳細</div>
          <div onClick={() => this.props.setDisplayBoxModal(false, this.props.modalContent)} className="close">
            &times;
          </div>
        </div>
        <div className="modal-content">
          <div className="modal-frame">
            <div className="modal-frame-flex">
              <div>
                ...
                <div className="score-box-label">
                  <span>{this.props.modalContent.label}</span>
                </div>
              </div>
              <div>
                <label>保管場所</label>
            ...
            <div className="links">
              <div onClick={() => this.props.updateBoxLocate()}>
  ...
  render() {
    ...
    return (
      <div className={'score-box-modal' + lib.pcClass(this.props.pc)}>
        <div className={'score-box-info' + displayBoxModalClass + lib.pcClass(this.props.pc)}>{showModalContent}</div>
        <div
          className={'score-box-modal-background' + displayBoxModalClass}
          onClick={() => this.props.setDisplayBoxModal(false, this.props.modalContent)}
        ></div>
      </div>
    )
  }
