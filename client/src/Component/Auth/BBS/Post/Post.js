          ...
          <div className="form">
            <div>
              ...
              <input
                ...
                onChange={(e) => this.props.setPostName(e.target.value)}
              />
            </div>
            <div>
              <label>コメント</label>
              <textarea
                ...
                onChange={(e) => this.props.setPostText(e.target.value)}
              />
            </div>
            <div>
              <label>編集パス</label>
              <input
                type="password"
                tabIndex="3"
                value={this.props.postPass}
                onChange={(e) => this.props.setPostPass(e.target.value)}
              />
            </div>
          </div>
        </div>
        ...
        <div className={'box post-button' + lib.pcClass(this.props.pc)}>
          <div onClick={() => this.props.sendPost()} className="send-button">
            {this.props.loadingPost ? (
              ...
              <span>
                <i className="far fa-edit"></i>書き込む
              </span>
            )}
          </div>
        </div>
