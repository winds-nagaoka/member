    ...
    if (!mode) {
          ...
          <div className={'form-base reg' + lib.pcClass(this.props.pc)}>
            <div className={'form login' + lib.pcClass(this.props.pc)}>
              ...
              <div className="links">
                ...
                <button tabIndex="2" onClick={() => updateMode()} disabled={disabled}>
                  {buttonLabel}
                </button>
              </div>
            </div>
      ...
      return (
        <div className={'contents' + lib.pcClass(this.props.pc)}>
          <div className={'form-base reg' + lib.pcClass(this.props.pc)}>
            <div className={'form login' + lib.pcClass(this.props.pc)}>
              ...
              <div className="links">
                ...
                <button tabIndex="3" onClick={() => register()} disabled={disabled}>
                  {buttonLabel}
                </button>
              </div>
            </div>
          ...
          <div className="old">
            <a href="https://winds-n.com/member">旧会員専用ページはこちら</a>
          </div>
          <Footer />
        </div>
      )
